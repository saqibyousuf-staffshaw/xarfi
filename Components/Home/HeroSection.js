            ...
            <Container>
                <div className='flex items-center justify-between'>
                    <div className='content lg:max-w-[59.3%] w-full z-10'>
                        <div>
                            <h2 className='font-semibold md:text-[58px] text-[40px] leading-[100%] tracking-[0] font-urbanist text-white'>
                                Stay Fully Booked<br /> Fill All Your Empty Slots
                            </h2>
                            <Image width={618} height={42} alt='line' className='max-w-[618px] w-full mb-6' src={'/assets/images/line.svg'} />
                            <p className='font-normal text-[22px]  tracking-[0] font-urbanist text-white'>
                            ...
                            <div className='flex md:items-center mt-6 gap-[29.17px] md:flex-row flex-col'>
                                <Link href={"#waitingList"}><Button className={"py-[14px] font-semibold"} text={'Join the Waiting List'} /></Link>
                                <Link href={"#keyFeatures"}><button className='font-medium cursor-pointer text-[22px] leading-[100%] tracking-[0] font-urbanist text-white flex items-center'>
                    ...
                    <div className='lg:w-[calc(100%-59.3%)] lg:opacity-100 opacity-70 w-full lg:static absolute left-0 text-center flex items-center justify-center'>
                        <Image alt="appView" width={299.43} height={612} className='text-center drop-shadow-[0px_4px_35px_#FFFFFF0D]' src={'/assets/images/MobileScreen.png'} />
                    </div>
                </div>
            </Container>
        </div>
